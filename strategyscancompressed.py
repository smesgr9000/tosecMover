...
class StrategyScanCompressed(StrategyScan):
    ...
    Otherwise the file is checked. If does not match a known entry and is a
    ...
    If the ZIP has no entry or an error occurs doStrategyNoMatch 
    for the ZIP is called"""
